...
# Parâmetros pré-treinados para cada classe
class_params = {
    'cruise':    {'mu':0.0, 'sigma':0.5, 'alpha':0.8, 'prior':0.5},
    'turn':      {'mu':0.0, 'sigma':0.7, 'alpha':0.5, 'prior':0.3},
    'brake':     {'mu':-1.0,'sigma':0.6, 'alpha':0.2, 'prior':0.2},
}
